...
const TEMPLATES: AlimtalkTemplateInfo[] = [
  ...
  },
  {
    ...
    example: '안녕하세요, {{회원명}}님! {{취소일}} {{수업명}} 수업이 취소되었습니다. 사유: {{취소사유}}. 결제권이 복구됩니다.',
  },
  {
    id: '4',
    code: 'class_reminder',
  ...
  },
  {
    ...
    name: '결제권 만료 안내',
    description: '결제권 만료 7일 전 발송',
    variables: ['회원명', '잔여결제권', '만료일'],
    example: '안녕하세요, {{회원명}}님! 잔여 결제권 {{잔여결제권}}회가 {{만료일}}에 만료됩니다. 기간 내 사용해주세요.',
  },
  {
    id: '6',
    code: 'custom',
