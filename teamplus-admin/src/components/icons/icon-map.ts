import {
  ...
  UserCircle, ChevronRight, Search, Home,
  ...
  LogOut, Lock, Key, Phone,
  Map, MapPin, Clock, Calendar, Timer,
  Megaphone, ScrollText, Smartphone, ToggleLeft,
  CreditCard as PaymentIcon, Wallet, Receipt,
  Building2, UserCheck, UserX, UserPlus,
} from 'lucide-react';
...
// Admin 전용 도메인 아이콘
export const AdminDomainIcons = {
  push: Megaphone,
  terms: ScrollText,
  versions: Smartphone,
  appSettings: ToggleLeft,
  payments: PaymentIcon,
  settlements: Wallet,
  receipts: Receipt,
  clubs: Building2,
  memberApproval: UserCheck,
  memberReject: UserX,
  memberAdd: UserPlus,
} as const;
