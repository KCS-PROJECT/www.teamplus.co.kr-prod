...
export const MESSAGES = {
  ...
  unitNotice: {
    ...
    sectionSubtitleClass: "이 훈련 참가자에게 전달되는 공지예요",
    sectionSubtitleTournament: "이 대회 참가자에게 전달되는 공지예요",
    classChip: "훈련",
    tournamentChip: "대회",
    ...
    targetLabel: "공지 대상",
    targetPlaceholder: "공지를 보낼 훈련 또는 대회를 선택해주세요",
    targetClassGroup: "훈련",
    targetTournamentGroup: "대회",
    targetEmpty: "공지를 작성할 수 있는 훈련·대회가 없습니다.",
    targetNotManaged: "이 훈련·대회에 공지를 작성할 권한이 없습니다.",
    titleLabel: "제목",
