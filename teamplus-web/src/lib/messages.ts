...
export const MESSAGES = {
  ...
  payment2: {
    ...
    // 승인 뒤 영수증 조회가 실패한 경우 — 재결제를 유도하면 안 되고(돈이 나갔을 수 있음),
    //   기록 없음(404)·권한 없음(403)·네트워크 실패에서도 "완료"를 단정하면 안 된다.
    niceReceiptLoadFailed:
      "결제 결과를 확인하지 못했어요. 다시 확인하거나 결제 내역에서 확인해주세요.",
    retryVerify: "다시 확인하기",
    receiptUnavailable: "영수증을 불러올 수 없어요. 잠시 후 결제 내역에서 다시 시도해주세요.",
  ...
  // 환불 승인제 (Phase 1) — /payment/history 요청 + 소속 감독/ADMIN 승인=실행
  refund: {
    // ── 학부모: 요청 버튼 / 모달 / 배지 ──────────────────
    requestButton: "환불 요청",
    requestModalTitle: "환불을 요청할까요?",
    requestModalBody: "감독(운영자) 승인 후 처리됩니다.",
    requestModalConfirm: "환불 요청",
    requestModalCancel: "돌아가기",
    requestSubmit: "환불 요청",
    requestProcessing: "요청 중...",
    requestSuccess: "환불 요청이 접수되었습니다.",
    requestFailed: "환불 요청에 실패했습니다.",
    requestReasonLabel: "환불 사유",
    requestReasonPlaceholder: "환불 사유를 입력해주세요.",
    requestReasonRequired: "환불 사유를 입력해주세요.",
    requestPendingBadge: "환불 요청 중",
    requestRejectedBadge: "환불 거절",
    duplicateActive: "이미 처리 중인 환불 요청이 있습니다.",
    unsupportedPayment: "환불 요청을 지원하지 않는 결제입니다.",
    // ── 관리자 목록 ─────────────────────────────────────
    listTitle: "환불 요청",
    // "처리 필요" = 승인 대기·처리 중·실행 실패 포괄(서버 우선순위 순서 유지).
    tabPending: "처리 필요",
    tabHistory: "처리 이력",
    listEmptyPending: "처리가 필요한 환불 요청이 없습니다.",
    listEmptyHistory: "처리된 환불 요청이 없습니다.",
    listLoadFailed: "환불 요청 목록을 불러오지 못했습니다.",
    loadMore: "더 보기",
    loadingMore: "불러오는 중...",
    loadMoreFailed: "더 불러오지 못했습니다. 다시 시도해주세요.",
    listAnnounce: (n: number) => `처리 이력 ${n}건 표시 중`,
    pendingCountLabel: (n: number) => `처리 필요 ${n}건`,
    ...
    riskUsed: "이용 내역 있음",
    riskPostpaid: "후불 정산",
    riskTournament: "대회 참가비",
    // ── DIRECT(관리자 직접 환불) ────────────────────────
    sourceDirect: "직접 환불",
    usageDirect: "관리자가 직접 처리하는 환불 건입니다.",
    directHandled: "관리자가 처리하는 환불 건입니다.",
    // KG 미확정(PG 결과 미확정) — 관리자 정산 필요 안내
    kgUnconfirmedNotice: "PG 결과 확인 후 관리자 처리가 필요합니다.",
    ...
    reconcileMemoLabel: "확인 메모",
    reconcileMemoPlaceholder: "PG 확인 내용을 입력해주세요.",
    reconcileMemoRequired: "확인 메모를 입력해주세요.",
    reconcileConfirm: "정산 처리",
    reconcileProcessing: "처리 중...",
    reconcileSuccess: "정산 처리를 완료했습니다.",
    reconcileFailed: "정산 처리에 실패했습니다.",
    // ── 상세 ────────────────────────────────────────────
    detailTitle: "환불 요청 상세",
    detailLoadFailed: "환불 요청 정보를 불러오지 못했습니다.",
    paymentSectionTitle: "결제 정보",
    orderNumber: "주문번호",
    paymentMethod: "결제 수단",
    paymentAmount: "결제 금액",
    completedAt: "결제 일시",
    productLabel: "결제 상품",
    tidLabel: "승인번호",
    requesterSectionTitle: "요청 정보",
    requesterName: "요청자",
    requesterPhone: "연락처",
    childLabel: "수강생",
    requestReasonTitle: "환불 사유",
    requestedAt: "요청 일시",
    usageSectionTitle: "사용 현황",
    usageAttendanceCount: (n: number) => `사용 ${n}회`,
    usagePrepaidNone: "결제 후 사용 내역이 없습니다.",
    usagePrepaidClassCount: (n: number) => `수업 ${n}개`,
    usagePostpaidBasis: (count: number, unit: number) =>
      `출석 ${count}회 × ${unit.toLocaleString()}원`,
    usageTournamentGames: (n: number) => `경기 ${n}회`,
    usageCalculatedFee: "산정 참가비",
    snapshotVsCurrent: "요청 시점 / 현재 상태",
    snapshotStatus: "요청 시점",
    currentStatus: "현재 상태",
    historySectionTitle: "처리 이력",
    priorRefundExists: "이 결제에 이전 환불 이력이 있습니다.",
    decidedBy: "처리자",
    decidedAt: "처리 일시",
    ...
    approveMemoPlaceholder: "메모를 입력해주세요.",
    approveConfirm: "승인 및 실행",
    approveProcessing: "처리 중...",
    approveSuccess: "환불이 실행되었습니다.",
    approveFailed: "환불 실행에 실패했습니다.",
    // ── 거절 시트 ───────────────────────────────────────
    rejectCta: "환불 거절",
    rejectSheetTitle: "환불 요청 거절",
    rejectReasonLabel: "거절 사유",
    rejectReasonPlaceholder: "거절 사유를 입력해주세요.",
    rejectReasonRequired: "거절 사유를 입력해주세요.",
    rejectConfirm: "거절하기",
    rejectProcessing: "처리 중...",
    rejectSuccess: "환불 요청을 거절했습니다.",
    rejectFailed: "거절 처리에 실패했습니다.",
    // ── 재처리 (execution_failed 전용) ──────────────────
    reprocessCta: "환불 재처리",
    reprocessSheetTitle: "환불을 재처리할까요?",
    reprocessBodyPg: "PG 환불부터 다시 시도합니다.",
    reprocessBodyDbAfterPg:
      "PG 환불은 완료되었습니다. 내부 처리만 다시 반영합니다.",
    reprocessConfirm: "재처리하기",
    reprocessProcessing: "처리 중...",
    ...
    rejectedNotice: "거절된 요청입니다.",
    canceledNotice: "요청자가 철회한 요청입니다.",
    // ── 예외 상태 ───────────────────────────────────────
    alreadyHandled: "다른 담당자가 이미 처리했습니다.",
    alreadyHandledBy: (name: string, at: string) => `${name} · ${at} 처리됨`,
    noPermission: "이 환불 요청을 처리할 권한이 없습니다.",
    judgmentDataError: "판단 자료 일부를 불러오지 못해 승인할 수 없습니다.",
    offlineTitle: "네트워크 연결을 확인해주세요.",
    retry: "다시 시도",
    // 읽기 전용(승인 권한 없는 역할 — 코치 등)
    readOnlyForCoach: "승인 권한은 감독에게 있습니다.",
    // 미지/무효 상태(fail-closed) — 상세 처리 불가
    invalidDetail: "환불 요청 정보를 처리할 수 없습니다.",
    // URL 컨텍스트 불일치 — 다른 소속의 요청
    contextMismatch: "요청과 화면 정보가 일치하지 않습니다.",
    backToList: "목록으로",
    // 재조회 실패 → stale 안내(mutate 잠금)
    staleDetail: "최신 상태를 불러오지 못했습니다. 새로고침 후 처리해주세요.",
    refreshAction: "새로고침",
    // ── 배너 / 메뉴 ─────────────────────────────────────
    ...
    adminHandoffBody:
      "학부모 환불 요청은 소속 감독(운영자)이 승인·실행합니다. 결제 관리에서 직접 환불하지 않습니다.",
  },
  socialLogin: {
  ...
  /** 수업/대회 단위 공지 스트림 (설계 SoT: claudedocs/unit-notice-stream-design-2026-08-19.md) */
  unitNotice: {
    tabTeam: "팀 공지",
    tabUnit: "훈련·대회",
    sectionTitle: "공지사항",
    /** 상세 고정 블록 (밴드형) — 단위 전용 라벨·부제로 "이 단위의 공지"임을 명시.
     *  용어: BottomNav "훈련/대회" 탭과 동일하게 "훈련" (수업=결제·수강 문맥 표기) */
    sectionTitleClass: "훈련 공지",
    sectionTitleTournament: "대회 공지",
    sectionTitleTeam: "팀 공지",
    sectionSubtitleClass: "이 훈련 참가 학생의 학부모에게 전달되는 공지예요",
    sectionSubtitleTournament: "이 대회 신청자에게 전달되는 공지예요",
    sectionSubtitleTeam: "팀 전체에게 전달되는 공지예요",
    classChip: "훈련",
    tournamentChip: "대회",
    teamChip: "팀",
    /** 대상 칩 — 팀 행 [팀이름]+[전체] (훈련/대회는 참가 자녀 이름을 표시) */
    audienceAll: "전체",
    /** 관리 공지함 상태 필터 — 만료 구분 (서버 status 파라미터) */
    statusFilterAria: "공지 상태 필터",
    statusAll: "전체",
    statusOngoing: "게시 중",
    statusExpired: "만료",
    ...
    contentLabel: "내용",
    contentPlaceholder: "공지 내용을 입력해주세요",
    pinLabel: "상단 고정",
    attachLabel: "이미지 첨부",
    attachHint: "이미지 파일만, 장당 최대 10MB",
    attachInvalidType: "이미지 파일만 첨부할 수 있습니다.",
    attachTooLarge: "이미지는 10MB 이하만 첨부할 수 있습니다.",
    created: "공지가 등록되었습니다.",
    updated: "공지가 수정되었습니다.",
    deleted: "공지가 삭제되었습니다.",
    ...
    readSummary: "읽음 현황",
    readCount: (read: number, total: number) => `읽음 ${read}/${total}`,
    unreadListTitle: (n: number) => `아직 읽지 않은 분 ${n}명`,
    unreadEmpty: "모든 수신자가 읽었습니다.",
    remind: "다시 알리기",
    ...
    actionCancel: "취소",
    actionSubmit: "등록하기",
    managePageTitle: "공지사항 관리",
    tabsAria: "공지 종류",
    listTitle: "공지 목록",
    pinnedBadge: "고정",
    collapse: "접기",
    showMore: (n: number) => `${n}개 더보기`,
    detailAria: "공지 상세 보기",
    ...
    imagePick: "이미지 선택",
    uploading: "업로드 중...",
    attachRemoveAria: (name: string) => `${name} 첨부 제거`,
    maxImages: (n: number) => `이미지는 최대 ${n}장까지 첨부할 수 있습니다.`,
    periodLabel: "노출 기간",
    periodHint: "설정한 기간에만 공지가 노출됩니다. 비워두면 상시 노출됩니다.",
    periodStart: "시작일",
    periodEnd: "종료일",
    periodReset: "기간 초기화 (상시 노출)",
    submitting: "등록 중...",
    updating: "수정 중...",
  },
  notice: {
  ...
  tournament: {
    ...
    // [2026-08-20] 대회 기간 직접 입력(자동 파생 폐기) — 기간 ↔ 경기 일정 정합 검증.
    periodPairIncomplete: "시작일과 종료일을 함께 입력해주세요.",
    periodOrderInvalid: "시작일이 종료일보다 늦을 수 없습니다.",
    scheduleOutOfPeriod: (n: number) =>
      `${n}경기 날짜가 대회 기간을 벗어났습니다. 대회 기간을 확인해주세요.`,
  ...
  common: {
    ...
    timePicker: {
      ...
      hour: "시",
      minute: "분",
      // 종료 시각은 시작 시각을 고른 뒤에만 열린다. 2열 폼에서는 placeholder 에 사유를 적으면
      //   좁은 폭에서 잘려 읽히지 않으므로, 비활성 트리거를 눌렀을 때 toast 로 알린다.
      startTimeFirst: "시작 시간을 먼저 선택해주세요.",
      trainingStart: "훈련 시작 시간 선택",
      trainingEnd: "훈련 종료 시간 선택",
      quietHoursStart: "방해 금지 시작 시간",
      quietHoursEnd: "방해 금지 종료 시간",
      matchTime: "경기 시간",
      indexedMatchTime: (index: number) => `${index}경기 시간`,
    },
  ...
  // [추가 2026-07-02] 감독 매출 리포트(/statistics) 재구성 — 매출/수납/미수금 리포트 문구.
  statistics: {
    heroTitle: "매출 리포트",
    totalRevenue: "총 매출",
    prepaid: "선불",
    ...
    revenueTrend: "매출 추이",
    classRevenue: "수업별 매출",
    collectionTitle: "수납 관리",
    previousOutstanding: "이전 기간 미수",
    billed: "청구",
    collected: "수납",
    postpaidOutstanding: "미수",
    goToPayments: "결제 관리로 이동",
    memberTitle: "회원 현황",
    totalMembers: "총 회원",
    newMembers: "신규 회원",
    emptyRevenue: "수납 내역이 없습니다",
    emptyClassRevenue: "수업별 매출 데이터가 없습니다",
    emptyMembers: "회원 변동 데이터가 없습니다",
    noManagedTeams: "관리 중인 팀이 없습니다",
    prevPeriod: "이전 기간",
    nextPeriod: "다음 기간",
    selectable: "선택형",
    noChange: "변동 없음",
  ...
  tournamentForm: {
    ...
    // [2026-08-20] 대회 기간 수동 입력 복원(자동 산출 폐기) — 기간은 저절로 바뀌지 않는다.
    periodTbdHint:
      "기간을 비워두면 '일정 미정' 대회로 등록되며, 참가 신청은 바로 받을 수 있습니다.",
    scheduleHint:
      "경기별 상대팀과 일정을 입력하세요. 경기 날짜는 대회 기간 안에서만 선택할 수 있습니다",
    scheduleTbdHint:
      "경기 일정 없이도 등록할 수 있습니다. 일정이 확정되면 대회 수정에서 추가하세요.",
    // 수정 모드 빈 상태 — "대회 수정에서" 자기참조를 피하고 하단 버튼 안내로 대체.
    scheduleTbdHintEdit:
      "등록된 경기가 없습니다. 일정이 확정되면 아래 버튼으로 경기를 추가하세요.",
