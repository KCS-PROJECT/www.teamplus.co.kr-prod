    ...
    <MobileContainer hasBottomNav>
      ...
      >
        ...
        {!isChildrenLoading && !hasEligibleChildren && (
          <div className="rounded-xl bg-amber-50 dark:bg-amber-900/20 border border-amber-100 dark:border-amber-900/30 p-4 flex items-start gap-3">
            <Icon
              name="info"
              size={20}
            ...
            <div className="flex-1">
              <p className="text-card-body font-semibold text-amber-800 dark:text-amber-200">
                {MESSAGES.awards.needTeamMembership}
              </p>
              <p className="text-card-meta text-amber-700 dark:text-amber-300 mt-1">
