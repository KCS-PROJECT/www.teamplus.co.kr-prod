...
export default function ParentOverseasTripDetailPage() {
    ...
    return (
      <MobileContainer hasBottomNav>
        ...
        <div className="flex flex-col items-center justify-center py-20">
          <Icon
            name="flight"
            className="mb-3 text-4xl text-wtext-4 dark:text-rink-500"
          />
  ...
  return (
    <MobileContainer hasBottomNav>
      ...
      <section
        aria-label="원정 기본 정보"
        className="bg-white dark:bg-rink-800 border-b border-wline-2 dark:border-rink-700 px-4 pb-4 pt-4"
      >
        {/* 썸네일 영역 */}
        <div
          className="mb-4 flex items-center justify-center h-32 rounded-2xl bg-blue-50 dark:bg-blue-900/20 border border-wline-2 dark:border-rink-700"
          aria-hidden="true"
        >
          <Icon name="flight_takeoff" className="text-6xl text-ice-500" />
        </div>

        <div className="flex items-start gap-2">
          <h2 className="flex-1 text-card-title font-bold text-wtext-1 dark:text-white leading-snug">
            {trip.title}
          </h2>
          <span
        ...
        {isRegistered && (
          <div
            className="mt-4 flex items-center justify-between rounded-xl bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-900/30 p-3"
            role="status"
          >
            <div className="flex items-center gap-2.5">
              <div className="flex items-center justify-center size-9 rounded-w-pill bg-blue-100 dark:bg-blue-900/40 shrink-0">
                <Icon
                  name="check_circle"
                  className="text-card-title text-blue-600 dark:text-blue-400"
                  aria-hidden="true"
                />
              </div>
              <div className="min-w-0">
                <p className="text-card-body font-semibold text-blue-900 dark:text-blue-300">
                  참가 신청 완료
                </p>
                <p className="text-card-meta text-ice-500 dark:text-blue-400">
                  상태:{" "}
                  {
            ...
            {myRegistration!.status !== "cancelled" && (
              <button
                ...
                className="shrink-0 rounded-lg px-4 py-2 text-card-body font-semibold text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors motion-reduce:transition-none min-h-[48px] min-w-[48px]"
              >
                취소하기
              </button>
            )}
      ...
      <div className="flex flex-col gap-3 p-4 pb-28">
        ...
        <section
          ...
          className="rounded-2xl bg-white dark:bg-rink-800 border border-wline-2 dark:border-rink-700 shadow-sm p-5"
        >
          <div className="flex items-center gap-2 mb-3">
            <div className="flex items-center justify-center size-7 rounded-lg bg-blue-50 dark:bg-blue-900/20">
              <Icon
                name="how_to_reg"
                className="text-card-body text-ice-500"
                aria-hidden="true"
              />
            </div>
            <h3
        ...
        {trip.itinerary && (
          ...
          >
            <div className="flex items-center gap-2 mb-3">
              <div className="flex items-center justify-center size-7 rounded-lg bg-indigo-50 dark:bg-indigo-900/20">
                <Icon
                  name="timeline"
            ...
            <div className="rounded-lg bg-ice-500/5 dark:bg-indigo-900/15 p-4">
              <p className="whitespace-pre-wrap text-card-body leading-relaxed text-wtext-2 dark:text-rink-100">
                {trip.itinerary}
              </p>
            </div>
            ...
            <div className="flex flex-col gap-2">
              {trip.contactPhone && (
                <a
                  ...
                  className="flex items-center gap-2 min-h-[48px] px-3 rounded-lg bg-wbg dark:bg-rink-900/50 text-card-body font-semibold text-ice-500 hover:bg-wline-2 dark:hover:bg-rink-900 transition-colors motion-reduce:transition-none tabular-nums"
                >
              ...
              {trip.contactEmail && (
                <a
                  ...
                  className="flex items-center gap-2 min-h-[48px] px-3 rounded-lg bg-wbg dark:bg-rink-900/50 text-card-body font-semibold text-ice-500 hover:bg-wline-2 dark:hover:bg-rink-900 transition-colors motion-reduce:transition-none"
                >
      ...
      {showRegForm && (
        ...
        >
          <div
            className="w-full max-w-md rounded-t-2xl bg-white dark:bg-rink-800 px-5 pb-8 pt-5"
          ...
          >
            <div className="mb-5 flex items-center justify-between">
              ...
              <button
                type="button"
                onClick={() => setShowRegForm(false)}
                className="flex min-h-[48px] min-w-[48px] items-center justify-center rounded-w-pill text-wtext-3 hover:bg-wline-2 dark:hover:bg-rink-700 transition-colors motion-reduce:transition-none focus:outline-none focus-visible:ring-2 focus-visible:ring-ice-500/40"
            ...
            <div className="flex flex-col gap-4">
              <div>
                <label className="mb-1.5 block text-card-body font-semibold text-wtext-2 dark:text-rink-100">
                ...
                <input
                  ...
                  className="w-full h-12 rounded-xl border border-wline dark:border-rink-700 bg-white dark:bg-rink-700 px-3.5 text-card-body text-wtext-1 dark:text-white placeholder:text-wtext-3 dark:placeholder:text-wtext-3 focus:outline-none focus:ring-2 focus:ring-ice-500/30 focus:border-ice-500 transition-colors motion-reduce:transition-none"
                />
              </div>
              <div>
                <label className="mb-1.5 block text-card-body font-semibold text-wtext-2 dark:text-rink-100">
                ...
                <input
                  ...
                  className="w-full h-12 rounded-xl border border-wline dark:border-rink-700 bg-white dark:bg-rink-700 px-3.5 text-card-body text-wtext-1 dark:text-white placeholder:text-wtext-3 dark:placeholder:text-wtext-3 focus:outline-none focus:ring-2 focus:ring-ice-500/30 focus:border-ice-500 transition-colors motion-reduce:transition-none tabular-nums"
                />
              </div>
              <div>
                <label className="mb-1.5 block text-card-body font-semibold text-wtext-2 dark:text-rink-100">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full resize-none rounded-xl border border-wline dark:border-rink-700 bg-white dark:bg-rink-700 px-3.5 py-2.5 text-card-body text-wtext-1 dark:text-white placeholder:text-wtext-3 dark:placeholder:text-wtext-3 focus:outline-none focus:ring-2 focus:ring-ice-500/30 focus:border-ice-500 transition-colors motion-reduce:transition-none"
                />
              </div>
              ...
              */}
              <section className="rounded-xl border border-flame-500/40 bg-flame-100/30 dark:bg-flame-500/10 p-3.5 space-y-2.5">
                <h4 className="text-card-body font-bold text-wtext-1 dark:text-white flex items-center gap-1.5">
                  <Icon name="warning_amber" className="text-flame-500 text-card-emphasis" />
                  해외원정 필수 동의 사항
                </h4>
                ...
                <label className="flex items-start gap-2.5 cursor-pointer">
                  <input
                    ...
                    className="mt-0.5 size-4 accent-ice-500 shrink-0 cursor-pointer"
                  />
                  <span className="text-card-meta text-wtext-2 dark:text-rink-100 leading-relaxed">
                    <span className="text-red-600 font-bold">[필수]</span> 자녀의 여권이 출국일 기준 <strong>6개월 이상 유효</strong>함을 확인했습니다.
                  </span>
                </label>
                ...
                <label className="flex items-start gap-2.5 cursor-pointer">
                  ...
                  />
                  <span className="text-card-meta text-wtext-2 dark:text-rink-100 leading-relaxed">
                    <span className="text-red-600 font-bold">[필수]</span> 자녀의 <strong>여행자 보험 가입</strong>에 동의하며, 보험 가입증명서를 출발 7일 전까지 제출하겠습니다.
                  </span>
                </label>
                ...
                <label className="flex items-start gap-2.5 cursor-pointer">
                  ...
                  />
                  <span className="text-card-meta text-wtext-2 dark:text-rink-100 leading-relaxed">
                    <span className="text-red-600 font-bold">[필수]</span> 만 14세 미만 자녀의 경우 <strong>법정대리인(보호자) 동반</strong> 또는 클럽 지정 인솔자 동반에 동의합니다. (청소년보호법)
                  </span>
                </label>
              </section>
              ...
              <div className="flex items-center gap-2 pt-2">
                <button
                  ...
                  onClick={() => setShowRegForm(false)}
                  disabled={isRegistering}
                  className="h-12 px-5 min-w-[96px] rounded-xl bg-wline-2 dark:bg-rink-700 text-wtext-2 dark:text-rink-100 font-semibold text-card-body hover:bg-wline dark:hover:bg-rink-500 transition-colors motion-reduce:transition-none active:brightness-95 disabled:opacity-60"
                >
                  취소
                </button>
                <button
                  ...
                  className="flex-1 h-12 rounded-xl bg-ice-500 hover:bg-ice-700 text-white font-bold text-card-emphasis shadow-md transition-colors motion-reduce:transition-none active:brightness-95 disabled:bg-wline disabled:text-wtext-3 dark:disabled:bg-rink-500 disabled:shadow-none"
                >
      ...
      {showCancelConfirm && (
        ...
        >
          <div
            className="w-full max-w-sm rounded-2xl bg-white dark:bg-rink-800 p-6 shadow-md"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex items-center gap-2 mb-2">
              <div className="flex items-center justify-center size-9 rounded-w-pill bg-red-50 dark:bg-red-900/20">
                <Icon
                  name="error"
                  className="text-card-title text-red-600"
                  aria-hidden="true"
                />
              </div>
              <h3
            ...
            <div className="mt-6 flex gap-2">
              <button
                type="button"
                onClick={() => setShowCancelConfirm(false)}
                className="flex-1 h-11 rounded-xl bg-wline-2 dark:bg-rink-700 text-wtext-2 dark:text-rink-100 font-semibold text-card-body hover:bg-wline dark:hover:bg-rink-500 transition-colors motion-reduce:transition-none active:brightness-95"
              >
                아니요
              </button>
              <button
                ...
                className="flex-1 h-11 rounded-xl bg-red-600 hover:bg-red-700 text-white font-semibold text-card-body transition-colors motion-reduce:transition-none active:brightness-95 disabled:bg-wline dark:disabled:bg-rink-500"
              >
      ...
      {/* 하단 참가 신청 버튼 */}
      {canRegister && (
        <div className="fixed bottom-0 left-0 right-0 z-30 flex justify-center bg-white dark:bg-rink-900 border-t border-wline-2 dark:border-rink-800 px-4 pb-6 pt-3">
          <button
            type="button"
            onClick={() => setShowRegForm(true)}
            className="w-full max-w-md min-h-[52px] rounded-xl bg-ice-500 hover:bg-ice-700 text-white font-bold text-card-emphasis shadow-md transition-colors motion-reduce:transition-none active:brightness-95"
          >
            참가 신청하기
          </button>
        </div>
      ...
      {trip.status === "open" &&
        ...
        !isRegistered && (
          <div className="fixed bottom-0 left-0 right-0 z-30 flex justify-center bg-white dark:bg-rink-900 border-t border-wline-2 dark:border-rink-800 px-4 pb-6 pt-3">
            <div className="w-full max-w-md min-h-[52px] flex items-center justify-center rounded-xl bg-wline-2 dark:bg-rink-800 text-card-body font-semibold text-wtext-3 dark:text-rink-300">
...
function InfoCard({
  ...
  return (
    <div className="rounded-xl bg-wbg dark:bg-rink-900/50 p-3 border border-wline-2 dark:border-rink-700">
      <div className="flex items-center gap-1.5">
        <Icon
          ...
          aria-hidden="true"
        />
        <p className="text-card-meta text-wtext-3 dark:text-rink-300">{label}</p>
      </div>
      <p
...
function InfoBlock({
  ...
  return (
    <div className="flex items-start gap-3">
      <div className="flex items-center justify-center size-8 rounded-lg bg-wline-2 dark:bg-rink-700 shrink-0 mt-0.5">
        <Icon
          name={icon}
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="mt-0.5 whitespace-pre-wrap text-card-body text-wtext-1 dark:text-white leading-relaxed">
          {value}
        </p>
      </div>
    </div>
