  ...
  return (
    <MobileContainer hasBottomNav>
      ...
      <main
        ...
        aria-label="장비 점검 현황"
      >
        {/* 자녀가 어디 팀에도 속해있지 않은 경우 안내 — flat 흰 섹션 */}
        {teams && teams.length === 0 && (
          <section className="bg-it-surface dark:bg-it-blue-950 px-5 pt-5 pb-6 text-center" aria-label="안내">
            <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-w-pill bg-it-fill dark:bg-rink-700">
              <Icon
                name="construction"
            ...
            <p className="text-card-body font-semibold text-it-ink-800 dark:text-wtext-4 mb-1">
              자녀가 소속된 팀이 없습니다.
            </p>
