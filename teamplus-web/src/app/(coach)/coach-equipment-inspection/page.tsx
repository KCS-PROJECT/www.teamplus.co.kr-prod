  ...
  return (
    <MobileContainer hasBottomNav>
      ...
      <main className="flex-1 overflow-y-auto px-4 pt-3 pb-24 hide-scrollbar">
        {!isAuthorized && (
          <div className="rounded-w-md bg-flame-100 dark:bg-flame-500/20 p-3 text-card-body text-flame-500 dark:text-flame-100">
        ...
        {/* 리스트 */}
        {isLoading ? (
          <div className="py-12 text-center text-wtext-3">
            불러오는 중…
          </div>
