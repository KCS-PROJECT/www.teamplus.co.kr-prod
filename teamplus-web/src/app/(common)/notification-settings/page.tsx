    ...
    <MobileContainer hasBottomNav={false} className="bg-wbg dark:bg-puck">
      ...
      <main className="flex-1 overflow-y-auto pb-8">
        ...
        <section className="mt-4 mx-4">
          <div className="bg-wsurface dark:bg-rink-800 rounded-w-xl shadow-sh-1 overflow-hidden">
            <div className="p-4">
              <Toggle
        ...
        <section className="mt-6 mx-4">
          <h2 className="text-card-meta font-bold text-wtext-3 dark:text-rink-300 uppercase tracking-wider px-1 mb-2">
            알림 카테고리
          </h2>
          <div className="bg-wsurface dark:bg-rink-800 rounded-w-xl shadow-sh-1 overflow-hidden divide-y divide-wline-2 dark:divide-rink-700">
            <div className="p-4">
              <Toggle
        ...
        <section className="mt-6 mx-4">
          ...
          <div className="bg-wsurface dark:bg-rink-800 rounded-w-xl shadow-sh-1 overflow-hidden">
            ...
            {settings.quietHours.enabled && settings.pushEnabled && (
              <div className="px-4 pb-4 pt-2 border-t border-wline-2 dark:border-rink-700">
                ...
                <div className="flex items-center gap-2">
                  <div className="flex-1 min-w-0">
                    <label className="block text-card-meta text-wtext-3 dark:text-rink-300 mb-1">
                      시작 시간
                    </label>
                    <input
                      type="time"
                      ...
                      className={cn(
                        ...
                        'border border-wline-2 dark:border-rink-600',
                  ...
                  <Icon
                    name="arrow_forward"
                    className="shrink-0 text-wtext-4 mt-5"
                    aria-hidden="true"
                  />
                  <div className="flex-1 min-w-0">
                    <label className="block text-card-meta text-wtext-3 dark:text-rink-300 mb-1">
                ...
                <p className="text-card-meta text-wtext-3 dark:text-rink-300 mt-3 tabular-nums">
        ...
        <section className="mt-6 mx-4">
          <button
            ...
            className="w-full py-3 text-card-body font-medium text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-w-md transition-colors motion-reduce:transition-none"
          >
            설정 초기화
          </button>
        </section>
        ...
        <section className="mt-6 px-5">
          <div className="flex items-start gap-3 p-4 bg-wsurface dark:bg-rink-800 rounded-w-md">
            <Icon name="info" className="text-wtext-4 dark:text-rink-400 flex-shrink-0 mt-0.5" />
