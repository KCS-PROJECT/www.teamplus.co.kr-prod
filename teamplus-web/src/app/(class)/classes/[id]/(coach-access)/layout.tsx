...
/**
 * (coach-access) — 수업 상세 하위 코치/감독 전용 라우트 그룹 layout (2026-05-20)
 *
 * RBAC SoT: 페이지가 아닌 layout 단위에서 useRequireRole 단일 호출.
 *   children 페이지(payments 등)는 가드 호출 금지 — 본 layout 이 isAllowed=false 시
 *   children 을 렌더링하지 않으므로 페이지는 항상 isAllowed=true 상태로 진입.
 *
 * 허용 역할: coach · director · academy_director · admin
 * 폴백 UI : DESIGN.md 토큰 사용 (ice-500 / wbg / wsurface / rink) — gradient/blur 0.
 */
