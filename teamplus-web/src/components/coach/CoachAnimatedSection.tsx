...
export interface CoachAnimatedSectionProps {
  /** 자식 요소 */
  children: ReactNode;
...
/**
 * CoachAnimatedSection - 진입(fade-in + slide-up) 애니메이션 제거 (즉시 렌더).
 *
 ...
 */
export function CoachAnimatedSection({
  children,
  className = '',
}: CoachAnimatedSectionProps) {
