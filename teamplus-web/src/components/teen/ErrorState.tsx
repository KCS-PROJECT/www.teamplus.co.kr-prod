...
interface ErrorStateProps {
  /** 재시도 콜백 */
  onRetry: () => void;
  /** 에러 제목 (기본: '데이터를 불러올 수 없습니다') */
  title?: string;
  /** 에러 설명 (기본: MESSAGES.error.network) */
  description?: string;
  /** MobileContainer 래핑 여부 (기본: true) */
  fullPage?: boolean;
}

/**
 * 에러 발생 시 전체 페이지 또는 섹션에 표시하는 에러 상태 컴포넌트
 * 재시도 버튼 포함
 */
export function ErrorState({
  ...
  return <MobileContainer hasBottomNav>{errorContent}</MobileContainer>;
}
