...
const ROLES: Role[] = [
  {
    ...
    desc: '자녀별 수업 일정과 출석, 크레딧과 결제, 성장 리포트까지 보호자가 직접 확인하고 관리합니다.',
    bullets: ['자녀별 일정 · 출석', '크레딧 · 결제 관리', '성장 · 기술 리포트'],
    screens: [
      sc(`${S}/parent/00-dashboard.png`, '학부모 홈'),
      sc(`${S}/parent/09-calendar.png`, '자녀 일정'),
      sc(`${S}/parent/06-credits.png`, '크레딧'),
  ...
  },
  {
    ...
    screens: [
      ...
      sc(`${S}/director/10-credits.png`, '크레딧'),
